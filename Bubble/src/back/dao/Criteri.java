...
public class Criteri {
    ...
    public String toString() {
        return "Criteri{" + "critere=" + critere + ", restrictions=" + restrictions + ", offset=" + offset + ", limit=" + limit + '}';
    }
    ...
    public String initCritere() throws Exception{
         String val="";
         if(this.getCritere().isEmpty())val="";
         else{
         ...
         System.out.println("Init offset and init limit");
    ...
    public String initOffset(){
        if(this.getOffset()!=null){
            System.out.println("offset active");
