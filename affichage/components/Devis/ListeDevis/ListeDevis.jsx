...
import FileExporter from '../../Generalized/CRUD/Import-Export/FileExporter';
import FileImporter from '../../Generalized/CRUD/Import-Export/FileImporter';
import FetchHelper from '../../../Helper/FetchHelper';
import URLHelper from '../../../Helper/URLHelper';
import Loader from '../../Generalized/Loader';
import Multisearch from '../../Generalized/CRUD/Multisearch';
...
<TabDevis error={this.handlerror} deleting={this.props.deleting} cudable={this.props.cudable} headers={this.state.listTree.entete} uri={this.props.uri} data={this.state.listTree.liste} valuekey={this.state.listTree.valuekey} infoperso={this.state.listTree.infoperso} link={this.props.fiche} />
</>
)}
</div>
